...
TOOL_REGISTRY: Dict[str, ToolDefinition] = {
    ...
    "get_minting_info_by_height": ToolDefinition(
        name="get_minting_info_by_height",
        description="Fetch minting info for a block height.",
        params={"height": "integer (required)"},
        input_schema={
            "type": "object",
            "properties": {"height": {"type": "integer", "minimum": 0}},
        ...
        callable=get_minting_info_by_height,
    ),
    "list_block_signers": ToolDefinition(
        name="list_block_signers",
        description="List block signers.",
        params={},
        input_schema={
            "type": "object",
            "properties": {},
